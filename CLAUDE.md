# Dataset Forge – Session Bootstrap
...
- what it is doing right now (`DIRECTION.md`)
- where work stands (`CURRENT_STATUS.md`)

If a proposed implementation conflicts with `PROJECT_BIBLE.md`, explain the
