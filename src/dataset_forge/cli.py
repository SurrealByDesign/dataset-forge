...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="dataset-forge",
        description=(
            "Dataset Forge v0.5.0-alpha: inspect image datasets and write "
...
def main(argv: list[str] | None = None) -> int:
    ...
    if arguments[0] in _FUTURE_COMMANDS or arguments[0].startswith("--"):
        print(
            "Error: this command is not part of the public v0.5.0-alpha CLI. "
...
def _inspect_main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "v0.5.0-alpha is analysis only: findings are candidates for review.\n"
